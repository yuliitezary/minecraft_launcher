  ...
  <div class="table-responsive">
    ...
    <table class="table table-xs table-hover">
      ...
      <tr>
        ...
        <th class="text-center">{$lang['vote_startinfo']}</th>
        <th class="text-center">{$lang['vote_endinfo']}</th>
        <th class="text-center">{$lang['led_status']}</th>
        <th class="text-center">{$lang['vote_count']}</th>
		<th class="text-center">{$lang['edit_cl']}</th>
