...
HTML;
	...
	$(function(){
		...
		$('[data-rel=links]').tokenfield({
		  autocomplete: {
		    source: 'engine/ajax/find_tags.php?user_hash={$dle_login_hash}&mode=xfield',
			minLength: 3,
		    delay: 500
		  },
		  createTokensOnBlur:true
                    ...
                    <div class="tab-pane" id="tabextra" >
						<div class="panel-body">
							...
							<div class="form-group">
							  ...
							  <div class="col-md-10 col-sm-9">
								<input type="text" name="descr" id="autodescr" class="form-control width-500" maxlength="200" value="{$row['descr']}">
							  </div>
							 </div>
							<div class="form-group">
...
elseif( $action == "doeditnews" ) {
	...
	if( !count( $_POST['movecat'] ) ) {
		$movecat = array ();
		$movecat[] = '0';
	} else $movecat = $_POST['movecat'];
	...
	if( $no_permission ) {
		...
		msg( "success", $lang['edit_alleok'], $lang['edit_alleok_1'], array( $_SESSION['admin_referrer'] => $lang['add_s_3'], '?mod=editnews&action=editnews&id='.$item_db[0] => $lang['add_s_4'] ) );
	} else {
