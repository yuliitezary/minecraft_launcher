		...
		echo "<div class=\"text-center\"><b>" . $lang['user_nouser'] . "</b></div>";
			...
			$ip_link = <<<HTML
				...
				<a href="#" target="_blank" data-toggle="dropdown" class="status-info">{$row['logged_ip']}</a>
				  <ul class="dropdown-menu text-left">
				   <li><a href="https://www.nic.ru/whois/?ip={$row['logged_ip']}" target="_blank"><i class="fa fa-eye position-left"></i> {$lang['ip_info']}</a></li>
				   <li class="divider"></li>
		...
		while ( $row = $db->get_array() ) {
			...
			$ip_list[] = <<<HTML
				...
				<a href="#" target="_blank" data-toggle="dropdown" class="status-info">{$row['ip']}</a>
				  <ul class="dropdown-menu text-left">
				   <li><a href="https://www.nic.ru/whois/?ip={$row['ip']}" target="_blank"><i class="fa fa-eye position-left"></i> {$lang['ip_info']}</a></li>
				   <li class="divider"></li>
