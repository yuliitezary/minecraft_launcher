...
HTML;
	...
	<div class="panel-footer">
		<button id="catsort" class="btn bg-primary-600 btn-sm btn-raised position-left">{$lang['cat_posi']}</button><button class="btn bg-primary-600 btn-sm btn-raised position-left nestable-action" data-action="expand-all">{$lang['cat_expand']}</button><button class="btn bg-primary-600 btn-sm btn-raised nestable-action" data-action="collapse-all">{$lang['cat_collapse']}</button>
	</div>
</div>
<script>
	jQuery(function($){
