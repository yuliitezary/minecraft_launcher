...
while($row = $db->get_row()) {
	...
	if ($row['c_text']) {
		...
		$edit_link = "<br /><br /><a class=\"btn bg-primary btn-sm btn-raised\" href=\"" . $config['http_home_url'] . "admin.php?mod=comments&action=edit&id=" . $row['post_id'] ."#comment".$row['c_id']."\" target=\"_blank\"><i class=\"fa fa-pencil-square-o position-left\"></i> {$lang['opt_complaint_12']}</a>";
