...
<tr id="$holderid" {$uid}>
<td class="xfieldsdescr">$value[1]: [not-optional]<span style="color:red;">*</span>[/not-optional]</td>
<td class="xfields"><textarea name="xfield[$fieldname]" id="xf_$fieldname">{$fieldvalue}</textarea>{$value[18]}</td></tr>
HTML;
...
<div id="$holderid" class="form-group editor-group" {$uid}>
  <label class="control-label col-md-2">{$value[1]}: [not-optional]<span style="color:red;">*</span>[/not-optional]{$value[18]}</label>
  <div class="col-md-10">
     <textarea class="classic" style="width:100%;height:200px;max-width: 950px;" name="xfield[$fieldname]" id="xf_$fieldname">{$fieldvalue}</textarea>
  </div>
</div>
HTML;
